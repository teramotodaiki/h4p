;!function () {
  ...
  connected.then(function (_ref) {
    ...
    setTimeout(function () {
      ...
      emit('complete', completes, _ref.port);
    }, 100);
  ...
  if (!feeles.env.MODULE) {
    sourceElements.push(HTMLScriptElement);
  }
  sourceElements.forEach(function (constructor) {
  ...
  (function (view) {
    Object.defineProperties(feeles.env, {
      ...
      VIEW: {
        ...
        get: function get() {
          var current = hasView(view) ? view : { width: 300, height: 200 };
          return {
